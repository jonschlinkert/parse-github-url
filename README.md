# parse-github-url [![NPM version](https://badge.fury.io/js/parse-github-url.svg)](http://badge.fury.io/js/parse-github-url)  [![Build Status](https://travis-ci.org/.svg)](https://travis-ci.org/) 
...
* [github-short-url-regex](https://github.com/regexps/github-short-url-regex): Regex for converting github shorthand (user/repo#branch) url to object  
...
+ [github/git@github.com:jonschlinkert](https://github.com/git@github.com:jonschlinkert)
+ [twitter/git@github.com:jonschlinkert](http://twitter.com/git@github.com:jonschlinkert) 
